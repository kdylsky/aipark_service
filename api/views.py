...
def get_list(request, *args, **kwargs):
    ...
    context, serailizer = aipark_service.get_list(user, project_id, page)
...
def add_text_foward_index(request, *args, **kwargs):
    ...
    params.is_valid(raise_exception=True)
    return JsonResponse(aipark_service.add_forward(user, project_id, index, params.data), safe=False)
